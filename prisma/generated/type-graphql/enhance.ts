...
const outputsInfo = {
  ...
  PostGroupBy: ["id", "createdAt", "updatedAt", "title", "content", "published", "authorId", "count", "avg", "sum", "min", "max"],
  AggregateProfile: ["count", "avg", "sum", "min", "max"],
  ProfileGroupBy: ["id", "bio", "userId", "count", "avg", "sum", "min", "max"],
